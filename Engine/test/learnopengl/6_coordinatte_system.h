...
namespace glx061
{
    ...
    int main()
    {
        ...
        Shader myshader(GET_SHADER_PATH("/6/l1/vertex.vert"), GET_SHADER_PATH("/6/l1/fragment.frag"));
...
namespace glx062
{
    ...
    int main()
    {
        ...
        Shader myshader(GET_SHADER_PATH("/6/l2/vertex.vert"), GET_SHADER_PATH("/6/l2/fragment.frag"));
